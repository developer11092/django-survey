# Generated by Django 2.1.1 on 2019-04-01 11:38
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('conditional', models.BooleanField(verbose_name='Is it Conditional?')),
                ('condition_script', models.CharField(blank=True, help_text='Here you can set the logic jumps', max_length=250, null=True, verbose_name='Logic Jumps')),
                ('image', models.FileField(help_text='Upload either image or any other field', upload_to='survey/images/questions/%Y/%m/%d/', verbose_name='File Upload')),
